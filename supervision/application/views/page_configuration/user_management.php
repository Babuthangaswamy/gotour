...
$form_configuration['inputs'] = array(
	...
	'phone' 		   => array('type' => 'number',   'label_line_code' => 20, 'maxlength' => '10', 'DT' => 'PROVAB_SOLID_I10'),
...
'form_header' => $form_attributes,
		'sections' => array(
			array('elements' => array('user_id', 'title', 'first_name', 'last_name', 'date_of_birth', 'country_code', 'phone', 'address', 'status', 'language_preference'),
				'fieldset' => 'FFL003'
			),
