	...
	<div class="panel panel-default clearfix"><!-- PANEL WRAP START -->
		...
		<div class="panel-body">
			...
			<div id="show-search" class="collapse">
				...
				<form method="GET" autocomplete="off" action="<?= base_url().'report/b2b_sightseeing_report?'?>">
					...
					<a href="<?=base_url().'report/b2b_sightseeing_report?' ?>" id="clear-filter" class="btn btn-primary">Clear Filter</a>
					</div>
