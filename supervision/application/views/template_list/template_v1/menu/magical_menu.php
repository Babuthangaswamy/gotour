...
<ul class="sidebar-menu" id="magical-menu">
	...
	<li class="treeview">
		<a href="#">
		<i class="far fa-wrench"></i> <span>Management</span> <i class="far fa-angle-down pull-right"></i>
		</a>
	...
	<li class="treeview">
		<a href="#">
		<i class="far fa-user"></i> <span>Markup</span> <i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Users </span><i class="far fa-angle-down pull-right"></i></a>
		<ul class="treeview-menu">
		<!-- USER TYPES -->
			<?php if($b2c){	?>
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Queues </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Reports </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
		<!-- USER TYPES -->
	...
	<li class="treeview">
		<a href="<?php echo base_url().'index.php/transaction/logs'?>">
			<i class="fas fa-shield"></i> 
			<span>  Transaction Logs  </span><i class="far fa-angle-down pull-right"></i>
		</a>			
	</li>

	<!-- <li class="treeview">
		<a href="#">
		<i class="far fa-money-bill"></i> <span>Account</span> <i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
	...
	<!-- <?php if($b2b) {?>
		<li class="treeview">
			<a href="#">
			<i class="far fa-briefcase"></i> <span>Commission</span> <i class="far fa-angle-down pull-right"></i>
			</a>
			<ul class="treeview-menu">
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Markup </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
		<!-- Markup TYPES -->
		<?php if($b2c) {?>
...
<!-- 	<li class="treeview">
	...
	<!-- <li class="treeview">
		<a href="#">
			...
			<span> Master Balance Manager </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
	...
	<li class="treeview">
		<a href="#">
			<i class="far fa-plus-square"></i> 
			<span> Package Management </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
		<!-- USER TYPES -->
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Email Subscriptions </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
		<!-- USER TYPES -->
	...
	<li class="treeview">
		<a href="#">
			...
			<span>CMS</span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
...
<li class="treeview">
		<a href="<?php echo base_url().'index.php/utilities/convenience_fees'?>">
			<i class="fas fa-shield"></i> 
			<span>  Convenience Fees </span><i class="far fa-angle-down pull-right"></i>
		</a>			
	</li>
	...
	<li class="treeview">
		<a href="#">
			...
			<span> Settings </span><i class="far fa-angle-down pull-right"></i>
		</a>
		<ul class="treeview-menu">
			<!-- <li>
