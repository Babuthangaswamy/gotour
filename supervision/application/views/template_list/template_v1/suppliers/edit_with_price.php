      ...
      <select class='form-control' data-rule-required='true' name='rating' id="rating" value ="" >
                ...
                <option><?php echo $packdata->rating;?></option>
                     ...
                     <div class='box-header blue-background'>
                      ...
                      <textarea name="includes" data-rule-required='true' class="form-control ckeditor" id="editor" cols="80" rows="10" placeholder="Price Includes" required><?php echo $packdata->price_includes;?></textarea>                             
                      ...
                      <textarea name="excludes" data-rule-required='true' class="form-control ckeditor" id="editor" cols="80" rows="10" placeholder="Price Excludes" required><?php echo $packdata->price_excludes;?></textarea>                             
</div>
                          </div>
                          <div class='box-header blue-background'>
