...
Class Custom_Db extends CI_Model
{
	...
	function get_phone_code_list(){
		$query = 'SELECT origin,country_code,name FROM api_country_list WHERE country_code!=0 GROUP BY (country_code) ORDER BY country_code';
