...
define('PROJECT_NAME','GOTOUR');
define('CURRENT_DOMAIN_KEY', 'TMX4212321542700803'); // FIXME//Vc8Z7XLsyys9TEQdFPkV
define('PROJECT_COOKIE_NAME', 'gotour');//FIXME
