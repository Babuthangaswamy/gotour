...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'voucher/bus/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
	$pdf_btn =  '<a href="'.base_url().'voucher/bus/'.$app_reference.'/'.$booking_source.'/'.$status.'/show_pdf'.'" class="viwedetsb">Pdf</a>';
	$action_tab .= $ticket_details;
	$action_tab .= $pdf_btn;
	if($status == 'BOOKING_CONFIRMED') {
		$cancel_ticket = '<a href="'.base_url().'bus/pre_cancellation/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">Cancel</a>';
