									...
									<div class="bookrow">
										...
										<div class="remful">
											<div class="xlbook col-sm-2 col-xs-3 htlimage_xl">
												<div class="imghtlflt">
													<img src="<?=$hotel_image?>" alt="HotelImage" />
												</div>
											</div>
											<div class="xlbook col-sm col-xs-9 htlimage_xl ">
												<div class="htlfltr">
													<h3 class="shtlname"><?=$hotel_name?></h3>
													<div class="shtlname"><?=app_friendly_absolute_date($hotel_check_in)?> to <?=app_friendly_absolute_date($hotel_check_out)?></div>
													<div class="starrting">
...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/hotel/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
	if($status == 'BOOKING_CONFIRMED') {
		$cancel_booking = '<a href="'.base_url().'index.php/hotel/pre_cancellation/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">Cancel</a>';
