									...
									<div class="bookrow">
										...
										<div class="remful">
											<div class="xlbook col-sm-2 col-xs-3 htlimage_xl">
												<div class="imghtlflt">
													<img src="<?=$attributes['ProductImage']?>" alt="ProductImage" />
												</div>
											</div>
...
{
	$action_tab  = '';
	$ticket_details = '<a href="'.base_url().'index.php/voucher/transferv1/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">View</a>';
	if($status == 'BOOKING_CONFIRMED') {
		$cancel_booking = '<a href="'.base_url().'index.php/transferv1/pre_cancellation/'.$app_reference.'/'.$booking_source.'" class="viwedetsb">Cancel</a>';
		$cancel_booking .= '<form action="" method="POST" name="shareemail-form">
														...
														<input type="hidden" value="transfers" name="module" />
