...
?>
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyAiR9CLZshY_vQpB7z5M7nIGCg16gfo2E8"></script>
	...
	function initialize()
	{
		var mapProp = {
		 ...
		 var image = "<?php echo $GLOBALS['CI']->template->template_images('marker/green_hotel_map_marker.png')?>";
