...
<!-- <img src="" alt="Hotel img" data-src="<?php //echo base_url().'index.php/hotel/image_cdn/'.$hd['ResultIndex'].'/'.$search_id.'/'.base64_encode($hd['HotelCode'])?>" class="lazy h-img"> -->
				...
				<?php else:?>
					<a href="javascript:void(0);">
					<img src="<?=$hd['HotelPicture']?>" alt="Hotel Image" data-src="<?=$GLOBALS['CI']->template->template_images('default_hotel_img.jpg') ?>" class="lazy h-img"></a>
				<?php endif;?>
				<?php
					/**
					...
					<div class="innd">
					   <div class="imptpldz">
						...
						<div class="shtlnamehotl">
							<a href="javascript:void(0);"><span class="h-name"><?php echo $hd['HotelName']?></span></a>
						</div>
