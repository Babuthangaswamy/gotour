...
<table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
<tbody>
							...
							<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
								<tbody>
									...
									<tr>
										...
										<td><span> <?php echo number_format($currency_conversion_rate*$fare_details['Fare']['BaseFare'], 2)?></span></td>
									</tr>
									
									<tr>
										<td><span>Taxes &amp; Fees</span></td>
										<td><span> <?php echo number_format(($currency_conversion_rate*$fare_details['Fare']['Tax']+$booking_details['admin_markup']+($currency_conversion_rate*$booking_details['convinence_amount'])-$booking_details['admin_commission']+$booking_details['admin_tds']), 2)?></span></td>
									</tr>
