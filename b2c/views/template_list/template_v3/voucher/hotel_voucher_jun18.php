...
$boarding_details ='';
if(isset($attributes['Boarding_details'])){
	
	foreach($attributes['Boarding_details'] as $boarding){
		$boarding_details .= $boarding.',';
	}
	$boarding_details = substr($boarding_details, 0, -1);
}
// echo $boarding_details;exit;
?>
	...
	<tr>
		<td style="border-collapse: collapse; padding:10px 20px 20px" >
			...
			<table width="100%" style="border-collapse: collapse;" cellpadding="0" cellspacing="0" border="0"><tr>
					<!-- <td style="padding: 10px;width:65%;"><img style="max-height:56px;" src="<?=$GLOBALS['CI']->template->domain_images('adoda.png')?>"></td> -->
					<td style="padding: 10px;width:35%">
                    	<table width="100%" style="border-collapse: collapse;text-align: right; line-height:15px;" cellpadding="0" cellspacing="0" border="0">
								...
								<td  width="100%" style="border: 1px solid #cccccc;">
									<table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
										<tr>
											...
											<td><strong>Boarding Deatils</strong></td>
                                        ...
                                        <td align="center"><?php echo $boarding_details; ?></span></td>
								...
								<td style="border: 1px solid #cccccc;">
									<table width="100%" cellpadding="5" style="padding: 10px;font-size: 13px;">
										...
										<tr>
                                            ...
                                            <td> <?php echo $booking_details['currency']; ?> <?php echo ceil($booking_details['grand_total']+$itinerary_details['Tax']); ?></td>
										</tr>
										<tr style="font-size:13px;">
                                        	<td colspan="5" align="right"><strong>Total Fare</strong></td>
											<td><strong><?php echo $booking_details['currency']; ?> <?php echo ceil($booking_details['grand_total']+$itinerary_details['Tax']); ?></strong></td>
										</tr>
									</table>
								</td>
								<td></td>
							...
							<tr><td>&nbsp;</td></tr>
							<tr>
								<td width="50%" style="padding: 10px;border: 1px solid #cccccc; font-size: 13px; font-weight: bold;">Customer Support</td>
							</tr>
							<tr>
								<td  width="100%" style="border: 1px solid #cccccc;">
									<table width="100%" cellpadding="5" style="padding: 10px 20px;font-size: 13px;">
										<tr>
                                        <td>#236/92/1A, 1st Floor, Venkataadri IT Park, Electronic City, Bangalore,Karnataka 560100, India.</td>
										</tr>
