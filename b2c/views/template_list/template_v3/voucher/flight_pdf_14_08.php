                           ...
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td style="line-height: 13px;"><span> <?php echo number_format($currency_conversion_rate*$fare_details['Fare']['BaseFare'], 2)?></span></td>
                                 </tr>
                                 <tr>
                                    <td style="line-height: 13px;"><span>Taxes &amp; Fees</span></td>
                                    <td style="line-height: 13px;"><span> <?php echo number_format(($currency_conversion_rate*$fare_details['Fare']['Tax']+$booking_details['admin_markup']+($currency_conversion_rate*$booking_details['convinence_amount'])-$booking_details['admin_commission']+$booking_details['admin_tds']), 2)?></span></td>
                                 </tr>
