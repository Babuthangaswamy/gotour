//used for autofocus when we select the value
var _auto_focus= [];
$(document).ready(function() {
   $(".first_name").keypress("keyup blur change focus", function(event) {
    ...
    $(".last_name").keypress("keyup blur change focus", function(event) {
       var inputValue = event.charCode;
        if(!(inputValue >= 65 && inputValue <= 120) && (inputValue != 32 && inputValue != 0)){
            event.preventDefault();
        }
     ...
     $(".agency_name").keypress("keyup blur change focus", function(event) {
       var inputValue = event.charCode;
        if(!(inputValue >= 65 && inputValue <= 120) && (inputValue != 32 && inputValue != 0)){
            event.preventDefault();
        }
    ...
    $('.phone').keypress("keyup blur change focus", function(event) {
 ...
 */
 ...
 $(document).ready(function(){
    ...
    //$("#show-search").collapse('show');
   var filter_query =  window.location.search;
    var filter_len = filter_query.length;
    var filter_list = $(".list_of_sections a.active");
    var filter_list_length  = filter_list.length;
    //console.log(filter_len);
    if(filter_list_length == 0 && filter_len > 0){     
          //console.log("show filter");     
          $("div#show-search").addClass("in");
          $(".toggle-btn").html("-");  
     }   
