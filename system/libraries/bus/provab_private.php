        ...
        if (valid_array($passengers) == true) {
            foreach ($passengers as $key => $passenger) {
                ...
                if ($module == 'b2c') {
                    ...
                    // echo 'herere'.$admin_commission;exit;
                ...
                $CI->bus_model->save_booking_customer_details($app_reference, $name, $age, $gender, $seat_no, $fare, $status, $seat_type, $is_ac_seat, $admin_commission, $admin_markup, $agent_commission, $agent_markup, $currency, $attr, $admin_tds, $agent_tds, $gst_value);
            }
        }
