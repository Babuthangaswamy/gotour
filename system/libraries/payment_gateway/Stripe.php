...
class Stripe {
    ...
    function initialize($data)
    {
        if ($this->active_payment_system == 'test') {
            //test
            self::$apikey = 'pk_test_bFRlGomo4MtVpsMufsLknq5u';//'';
            self::$clientid = 'cus_DxUld6sPuMflQy';//'ca_B5w1hMVL00692Qxl2obf8USCihlh4bFy';
            self::$url = 'https://connect.stripe.com/oauth/authorize'; 
        } else {
            //live
             self::$apikey = 'pk_live_jsaA6LLSqOZlWvjTDHrtXp2h';
            self::$clientid = 'cus_DxUld6sPuMflQy';
            self::$url = 'https://connect.stripe.com/oauth/authorize';  
        }
    ...
    public static $apiKey = 'sk_test_ExVNkySx3QiypeVHLREsQrUV';
    //'sk_test_MdP1j2oWguWcMbahEydz7VPB'
   // public static $apiKey = 'sk_live_KSEt7XqHD2nF6SEa58Xpw1HZ';// live stripe key for topfly

    // @var string The Stripe client_id to be used for Connect requests.
    public static $clientId = 'cus_DxUld6sPuMflQy';//'ca_B5w1hMVL00692Qxl2obf8USCihlh4bFy';
