...
class Provab_private extends Common_Api_Grind {
	...
	private function get_header() {
		$hotel_engine_system = $this->CI->config->item ( 'transfer_engine_system' );
	...
	private function set_api_credentials() {
		...
		$this->Url = $this->CI->config->item ( 'transferv1_url' );
	...
	*/
	public function get_transfer_list($safe_search_data){
