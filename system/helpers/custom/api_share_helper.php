...
{
	return '<a href="'.car_voucher_url($app_reference, $booking_source, $status).'/show_voucher" target="_blank" class="btn btn-sm btn-primary flight_v"><i class="far fa-file"></i> Voucher</a>';
}
...
{
	return '<a href="'.car_voucher_url($app_reference, $booking_source, $status).'/show_pdf" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Pdf</a>';
}
...
{
	return '<a href="'.cancel_car_booking_url($app_reference, $booking_source, $status).'" target="_blank" class="btn btn-sm btn-warning"><i class="far fa-arrows-alt"></i> Cancel</a>';
}
...
{
	return '<a href="'.hotel_voucher_url($app_reference, $booking_source, $status,$module).'/show_voucher" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Voucher</a>';
}
...
{
	return '<a href="'.hotel_pdf_url($app_reference, $booking_source, $status).'/show_pdf" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Pdf</a>';
}
...
{
	return '<a href="'.cancel_hotel_booking_url($app_reference, $booking_source, $status).'" target="_blank" class="btn btn-sm btn-warning"><i class="far fa-arrows-alt"></i> Cancel</a>';
}
...
{
	return '<a href="'.sightseeing_voucher_url($app_reference, $booking_source, $status,$module).'/show_voucher" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Voucher</a>';
}
...
function sightseeing_pdf($app_reference, $booking_source='', $status='',$module='')
{
	...
	return '<a href="'.sightseeing_pdf_url($app_reference, $booking_source, $status,$module).'/show_pdf" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Pdf</a>';
}
...
{
	return '<a href="'.cancel_sightseeing_booking_url($app_reference, $booking_source, $status,$module).'" target="_blank" class="btn btn-sm btn-warning"><i class="far fa-arrows-alt"></i> Cancel</a>';
}
...
{
	return '<a href="'.transfers_voucher_url($app_reference, $booking_source, $status,$module).'/show_voucher" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Voucher</a>';
}
...
function transfers_pdf($app_reference, $booking_source='', $status='', $module='')
{
	...
	return '<a href="'.transfers_voucher_url($app_reference, $booking_source, $status, $module).'/show_pdf" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Pdf</a>';
}
...
{
	return '<a href="'.cancel_transfers_booking_url($app_reference, $booking_source, $status,$module).'" target="_blank" class="btn btn-sm btn-warning"><i class="far fa-arrows-alt"></i> Cancel</a>';
}
...
function flight_voucher($app_reference, $booking_source='', $status='',$module='')
{
	...
	return '<a href="'.flight_voucher_url($app_reference, $booking_source, $status,$module).'/show_voucher" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Voucher</a>';
}
...
{
	// echo $status;exit;
	return '<a href="'.flight_voucher_url($app_reference, $booking_source, $status, $module).'/show_pdf" target="_blank" class="btn btn-sm btn-primary"><i class="far fa-file"></i> Pdf</a>';
}
