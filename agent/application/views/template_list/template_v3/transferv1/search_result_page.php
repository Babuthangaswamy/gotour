...
var load_products = function(loader, offset, filters){
	...
	_lazy_content = $.ajax({
		type: 'GET',
		url: app_base_url+'index.php/ajax/transferv1_list/'+offset+'?booking_source=<?=$active_booking_source[0]['source_id']?>&search_id=<?=$sight_seen_search_params['search_id']?>&op=load'+url_filters,
		async: true,
		cache: true,
		dataType: 'json',
	                            ...
	                            <div class="col-xs-12 nopad">
	                                <div class="insidemyt">
										<ul class="sortul">
											...
											<li class="sortli threonly"><a class="sorta name-l-2-h loader asc"><i class="fas fa-sort-alpha-down"></i> <strong>Name</strong></a><a
												class="sorta name-h-2-l hide loader des"><i class="fa fa-sort-alpha-desc"></i> <strong>Name</strong></a></li>
											
											<li class="sortli threonly"><a class="sorta star-l-2-h loader asc"><i class="fas fa-star"></i> <strong>Rating</strong></a><a
												class="sorta star-h-2-l hide loader des"><i class="fas fa-star"></i> <strong>Rating</strong></a></li>
																					
											<li class="sortli threonly"><a class="sorta price-l-2-h loader asc"><i class="fas fa-tag"></i> <strong>Price</strong></a><a
							...
							<div class="celsrch refine">
								...
								<div class="rangebox">
									...
									<div id="hotelsearch-refine" class="in">
										<div class="boxins">
											<div class="relinput">
												<input type="text" class="srchhtl" placeholder="Transfers Names" id="tour-name" />
...
<!-- 								<div class="rangebox">
												...
												<div class="insidemyt">
													<ul class="sortul">
														...
														<li class="sortli threonly" data-sort="sr">
															<a class="sorta star-l-2-h asc" data-order="asc"><i class="fas fa-star"></i> <strong>Rating</strong></a>
															<a class="sorta star-h-2-l hide  des" data-order="desc"><i class="fas fa-star"></i> <strong>Rating</strong></a>
														</li>
													...
													<!-- 	<li class="sortli threonly" data-sort="p">
														<a class="sorta"><i class="fas fa-tag"></i><strong>Price</strong></a>
	...
	<div id="empty-search-result" class="jumbotron col-xs-12" style="display:none">
