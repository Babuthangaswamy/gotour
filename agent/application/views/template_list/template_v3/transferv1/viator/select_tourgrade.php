    ...
    <div class="org_row">
      <div class="col-md-12 actresdv">
       ...
       <?php  echo date("l\, jS F Y",strtotime($booking_date)); ?></p>
        <a class="snf_btn pull-left ondet active" title="Show Net Fare">
			<span class="fas fa-tag"></span>
			<span class="tag_snf">SNF</span>
		</a>
        </div>
		      	...
		      	<div class="light-border-t mbl">
		            ...
		            <?php endif;?>
		               ...
		               <?php 
			                ...
			                $agent_commission = $t_value['Price']['_Commission'];
			                $tds_oncommission = $t_value['Price']['_tdsCommission'];
			                $agent_earning = $t_value['Price']['_AgentEarning'];
			                $agent_markup = $t_value['Price']['_Markup'];
		                 ...
		                 <div style="display:none" class="net-fare-tag snf_hnf" title="C <?=$agent_commission-$tds_oncommission?>+M <?=$agent_markup?> =<?=$agent_earning?> "><?php echo $currency_obj->get_currency_symbol($currency_obj->to_currency); ?> <?=$t_value['Price']['NetFare']?></div>
		                <div class="">
		                 <form method="post" action="<?=base_url()?>index.php/transferv1/booking"> 
