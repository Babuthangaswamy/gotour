...
$total_profit = $pre_booking_params['markup_price_summary']['TotalDisplayFare']-$pre_booking_params['markup_price_summary']['NetFare'];
		...
		<div class="col-xs-4 full_room_buk rhttbepa">
		   <div id="slidebarscr">
		 	<table class="table table-condensed tblemd">
			     ...
			     <tr>
				        <th>Total Payable</th>
				        <td><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <?=$agent_payable?></td>
				      </tr>
				      <tr>
				        <th>Total Earned</th>
				        <td><?=$this->currency->get_currency_symbol($pre_booking_params['default_currency'])?> <?=$total_profit?></td>
				      </tr>
			  ...
			  <div class="hotelistrowhtl">
				...
				<div class="col-md-8 padall10 xcel">
				  ...
				  <div class="bokkpricesml">
					...
					<!-- <div class="show-price-deduction">
						
						<span class="comm">Total Payable : <?=$currency_symbol.''.$agent_payable?></span>
						<span class="comm">Total Earned : <?=$currency_symbol.''.$total_profit?></span>
					</div> -->
...
$lead_pax_details = @$pax_details[0];
 ?>
<form action="<?=base_url().'index.php/transferv1/pre_booking/'.$search_id?>" method="POST" autocomplete="off">
