            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="<?= base_url() ?>index.php/report/transfers" class="">more info
                        </a>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="<?= base_url() ?>index.php/report/activities" class="">more info
                        </a>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="<?= base_url() ?>index.php/report/car" class="">more info
                        </a>
                    </div><!-- /.info-box-content -->
                </div><!-- /.info-box -->
            </div>
