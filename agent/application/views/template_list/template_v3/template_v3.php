  ...
  <noscript><img src="<?php echo $GLOBALS['CI']->template->template_images('default_loading.gif'); ?>"
	...
	?>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
			...
			foreach ($master_module_list as $k => $v) {
				...
				?>
				<li class="normal_srchreali <?=((@$default_view == $k || $default_view == $v) ? 'bg-blue' : '')?>"><a href="<?php echo base_url()?>index.php/menu/dashboard/<?php echo ($v)?>?default_view=<?php echo $k?>"><i class="<?=get_arrangement_icon($k)?>"></i> <span class="none_lables"><?php echo ucfirst($v)?></span></a></li>
				<?php
				}
			}
			?>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-body">
                    <div class="col-xs-6 nopad text-left">
                      <a href="<?php echo base_url().'index.php/user/account?uid='.intval($GLOBALS['CI']->entity_user_id); ?>" class="flt_btn">Profile</a>
                    </div>
                    <div class="col-xs-6 nopad text-right">
                      <a href="<?php echo base_url().'index.php/user/change_password?uid='.intval($GLOBALS['CI']->entity_user_id);?>" class="flt_btn">Change Password</a>
                    </div>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y')?> <?=HEADER_TITLE_SUFFIX?> pvt ltd</strong> All rights reserved.
      </footer>
		<!-- FOOTER ends -->
		<?php
