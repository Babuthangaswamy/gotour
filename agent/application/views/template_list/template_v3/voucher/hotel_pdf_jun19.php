							...
							<tr>
								<td  width="100%" style="border: 1px solid #cccccc;">
									<table width="100%" cellpadding="5" style="padding: 10px 20px;font-size: 11pt;">
										...
										<tr>
                                        <td>2.Please ensure that operator PNR is filled, otherwise the ticket is not valid.</td>
										</tr>
										<tr>
                                        <td>3.Please ensure that operator PNR is filled, otherwise the ticket is not valid.</td>
										</tr>
										<tr>
                                        <td>4.Please ensure that operator PNR is filled, otherwise the ticket is not valid.</td>
										</tr>
										<tr>
                                        <td>5.Please ensure that operator PNR is filled, otherwise the ticket is not valid.</td>
										</tr>
										<tr>
                                        <td>6.Please ensure that operator PNR is filled, otherwise the ticket is not valid.</td>
										</tr>
									</table>
								</td>
							</tr>	      				
