...
?>
<div class="table-responsive" id="tickect_flight">
<table
...
<?php } ?>
<table id="printOption"onclick="w=window.open();w.document.write(document.getElementById('tickect_flight').innerHTML);w.print();w.close(); return true;"
