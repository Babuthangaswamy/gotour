...
<div style="background:#ccc; width:100%; position:relative">
   <table cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt;font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         ...
         <tr>
            <td align="right" colspan="4" style="line-height:25px;font-size:14px; border-top:2px solid #00a9d6; border-bottom:1px solid #00a9d6;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[0]['status'])?>" >
               <?php
                           ...
                           <table cellspacing="0" cellpadding="5" width="100%" style="font-size:9pt; padding:0;border:1px solid #9a9a9a;">
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td style="line-height: 13px;"><span> <?php echo number_format($fare_details['Fare']['Tax'],2)?></span></td>
                                 </tr>
                                 ...
                                 <tr>
                                    ...
                                    <td style="border-top:1px solid #ccc;line-height: 13px;"><span style="font-size:10pt"> <?=number_format((@$booking_details['grand_total'] + $baggage_price + $meal_price + $seat_price),2)?></span></td>
                                 </tr>
                              </tbody>
                           </table>
                        </td>
...
<div style="background:#ccc; width:100%; position:relative">
   <table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:9pt; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate; color: #000;">
      <tbody>
         ...
         <tr>
            <td align="right" colspan="4" style="line-height:25px;font-size:14px;border-top:2px solid #00a9d6; border-bottom:1px solid #00a9d6;"><span style="font-size:9pt;">Status: </span><strong class="<?php echo booking_status_label($booking_transaction_details[1]['status'])?>" >
               <?php
         ...
         <tr>
            ...
            <td style="padding:10px 0; vertical-align:middle; text-align: center;border:1px solid #808080;line-height:15px;"><span style="font-size:10pt;line-height:normal;"><span style="color:#00a9d6;padding:5px;line-height:normal;">AIRLINE PNR</span><br><span style="font-size:15pt;line-height:normal;padding-bottom: 5px;font-weight: 600;"><?=@$return_airline_pnr?></span><br><span style="padding:5px;">GDS PNR:  <?=@$booking_transaction_details[1]['pnr']?></span></span></td>
            <?php } ?>
         </tr>
         <tr><td colspan="4" style="line-height:6px;padding:0;">&nbsp;</td></tr>
         <tr>
