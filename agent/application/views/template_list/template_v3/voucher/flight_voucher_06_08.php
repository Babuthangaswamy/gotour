...
<tbody>
	...
	<tr>
		<td colspan="2" style="padding-bottom:10px"><img style="width:200px;" src="<?=$GLOBALS['CI']->template->domain_images($data['logo'])?>" /></td>
					...
					if (isset ( $booking_transaction_details ) && $booking_transaction_details != "") {
							...
							foreach ( $itinerary_details as $segment_details_k => $segment_details_v ) { 
								...
								if(in_array($segment_details_v['segment_indicator'], $seg_in_array) && !empty($seg_in_array) && ($seg_counts == 0) && ($trip_type != 'multicity')){ 
									...
									?>
								<tr>
									<td colspan="2" style="background-color:#00a9d6; color:#fff"><img style="vertical-align:middle" src="<?=SYSTEM_IMAGE_DIR.'flight.png'?>"> &nbsp;<span style="vertical-align:middle;font-size:13px">Retun Flight Details</span></td>
									<td align="right" colspan="2" style="background-color:#00a9d6; color:#fff"><span style="font-size:10px">*Please verify flight times with the airlines prior to departure</span></td>
								</tr>
							...
							<table cellspacing="0" cellpadding="5" width="100%" style="font-size:12px; padding:0;border:1px solid #9a9a9a;">
								<tbody>
									...
									<tr>
										...
										<td><span> <?php echo number_format($fare_details['Fare']['Tax'], 2)?></span></td>
									</tr>
									...
									<tr>
										...
										<td style="border-top:1px solid #ccc"><span style="font-size:13px"><?=number_format((@$booking_details['grand_total'] + $baggage_price + $meal_price + $seat_price),2)?></span></td>
									</tr>
								</tbody>
							</table>
						</td>
...
<div style="background:#ccc; width:100%; position:relative">
<table class="pag_brk" cellpadding="0" border-collapse cellspacing="0" width="100%" style="font-size:12px; font-family: 'Open Sans', sans-serif; max-width:850px; margin:0px auto;background-color:#fff; padding:45px;border-collapse:separate;color: #000;">
<tbody>
	<tr>
	...
	<tr>
		...
		<td style="padding:10px 0;text-align: center;"><span style="font-size:14px; border:2px solid #808080; display:block"><span style="color:#00a9d6;padding:5px; display:block">AIRLINE PNR</span><span style="font-size:26px;line-height:35px;padding-bottom: 5px;display:block;font-weight: 600;"><?=@$return_airline_pnr?></span><span style="border-top:2px solid #808080;display:block; padding:5px;">GDS PNR:  <?=@$booking_transaction_details[1]['pnr']?></span></span></td>
		<?php } ?>
	</tr>
	<tr>
		<td colspan="4" style="border:1px solid #00a9d6; padding:0;">
