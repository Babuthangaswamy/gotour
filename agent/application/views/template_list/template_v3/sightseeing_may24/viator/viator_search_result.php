...
<div class="rowresult r-r-i col-xs-4">
	<div class="madgrid forhtlpopover">
		...
		<div class="col-xs-3 nopad listimage <?=$d_offer?>">
			<div class="imagehtldis">
				
				<?php if($product['ImageHisUrl']):?>

					<a href="<?php echo base_url()?>index.php/sightseeing/sightseeing_details?op=get_details&booking_source=<?=urlencode($booking_source)?>&search_id=<?=$search_id?>&product_code=<?=@$product['ProductCode']?>&result_token=<?=$product['ResultToken']?>"><img src="<?=$product['ImageHisUrl']?>" alt="Image" data-src="<?=$product['ImageHisUrl']?>" title="<?=$product['ProductName']?>" class="lazy h-img"></a>				
				<?php else:?>				 		
				 <a href="<?php echo base_url()?>index.php/sightseeing/sightseeing_details?op=get_details&booking_source=<?=urlencode($booking_source)?>&search_id=<?=$search_id?>&product_code=<?=@$product['ProductCode']?>&result_token=<?=$product['ResultToken']?>"><img src="<?=$product['ImageUrl']?>" alt="Image" data-src="<?=$product['ImageUrl']?>" title="<?=$product['ProductName']?>" class="lazy h-img"></a>	
