...
<div class="container">    
        <div class="fuldownsct">
            ...
            <div class="col-xs-4 nopad tab_htl_detail hide">
            <div class="padritside">
            	<div class="shdoww">
                <div class="umalso">
                    <div class="hdeingalso">You May Also Like</div>
                    <a class="rowlikes">
                        <div class="hotlealso">
                            <img src="/proapp_ng/extras/system/template_list/template_v3/images/city_1.jpg" alt="" />
                        </div>
                        <div class="alsodets">
                            <div class="alsohed">Hotel Amaragua</div>
                            <div class="starrting"><span class="rating-no"><span class="hide" id="h-sr"><?=$sanitized_data['StarRating']?></span><?php echo print_star_rating($sanitized_data['StarRating']);?></span></div>
                            <div class="pricealso">$36- $160 <strong>avg/night</strong></div>
                        </div>
                    </a>
                    <a class="rowlikes">
                        <div class="hotlealso">
