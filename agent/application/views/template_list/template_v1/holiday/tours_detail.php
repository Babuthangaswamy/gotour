...
<div id="subtqry" class="wellme minwnwidth" style="display: none;">
    ...
    <div class="signdiv">
      ...
      <div class="col-md-10 col-xs-12">
        ...
        <div class="col-md-6 col-xs-12"><button type="submit"  value="Send Enquiry" class="btn colorsave" id="startCancelProc">Send Enquiry</button></div>
        </div>
      </div>
      </form>
    </div>
