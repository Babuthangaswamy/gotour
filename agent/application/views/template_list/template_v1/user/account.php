                         ...
                         <?php if((empty($pan_number)) == true){
                          ...
                          <div id="pan_data" <?php echo $style; ?>>
                            <div class="col-xs-4 margpas">
                              <div class="tnlepasport_b2b">
                                ...
                                <div class="lablmain ">
                                  <input type="text" name="pan_number" placeholder="PAN Number" value="<?=$pan_number?>" class="clainput"  required="required" readonly maxlength="10">
                                </div>
                              </div>
                            </div>
                          </div>
                          <div class="col-xs-4 margpas">
                            <div class="tnlepasport_b2b">
                              ...
                              <div class="lablmain ">
                                <input type="text" name="office_phone" placeholder="PAN Number" value="<?=(($office_phone == 0 || $office_phone == '') ? '': $office_phone)?>" class="clainput"  required="required" readonly>
                              </div>
                            </div>
                          </div>
